...
#Autor: Henry Chumo 
#Alias : ChumoGH
source <(curl -sL https://raw.githubusercontent.com/JerrySBG/premium-bot/main/CHUMO/msg-bar/msg)

_mssBOT () {
xyz=$(curl -sSL "https://raw.githubusercontent.com/JerrySBG/premium-bot/main/CHUMO/Control/token.sh")
