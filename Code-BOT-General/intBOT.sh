#!/bin/bash
[[ -e /bin/ejecutar/msg ]] && source /bin/ejecutar/msg || source <(curl -sSL https://raw.githubusercontent.com/JerrySBG/premium-bot/main/Otros/msg)
bar="$(msg -bar3)"
...
function_verify () {
unset keybot
echo -e "\033[7;49;35m    =====>>►► 🐲 GEN JerrySBG${TTcent}VPS 🐲 ◄◄<<=====      \033[0m"
msg -bar
...
permited=$(curl -sSL "${link}/JerrySBG/premium-bot/main/Control/Control-Bot") 
} || {
permited=$(curl -sSL "${link}/JerrySBG/premium-bot/main/Control/Control-Bot")
}
 ...
 ### INTALAR VERCION DE SCRIPT
  ...
  echo -e " 	    Autorizada por @Jerry_SBG "
  echo -e "      SI DESEAS USAR EL BOTGEN CONTACTE A @Jerry_SBG"
  echo -e "\e[32m=====================================================\n\n\n\e[0m"
  ...
  v1=$(curl -sSL "https://raw.githubusercontent.com/JerrySBG/premium-bot/main/Code-BOT-General/v-new.log")
...
wget -q --no-check-certificate -O $HOME/files.tar https://raw.githubusercontent.com/JerrySBG/premium-bot/main/Code-BOT-Comandos/files.tar
...
msg -bar
echo -e " \033[7;49;35m ${TTini} 🐲 BotGEN JerrySBG${TTcent}ADM $(cat ${CIDdir}/vercion) 🐲 ◄◄<===   \033[0m"
msg -bar
