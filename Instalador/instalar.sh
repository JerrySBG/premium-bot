...
tittle() {
    ...
    clear && clear
    msg -bar
    echo -e "\033[1;44;44m   \033[1;33m=====>>►► 🐲 Premium 💥 Plus 🐲 ◄◄<<=====  \033[0m \033[0;33m[$(less /etc/${rt}/v-local.log)]"
    msg -bar
}
in_opcion() {
    unset opcion
...
[[ -d /bin/ejecutar ]] && {
    [[ -e /bin/ejecutar/msg ]] || wget -q -O /bin/ejecutar/msg https://raw.githubusercontent.com/JerrySBG/premium-bot/main/Otros/msg
} || mkdir /bin/ejecutar
cor[0]="\033[0m"
cor[1]="\033[1;34m"
cor[2]="\033[1;32m"
...
function_verify() {
    ...
    [[ -z $keybot ]] && {
        ...
        permited=$(curl -sSL "https://raw.githubusercontent.com/JerrySBG/premium-bot/main/Control/Control-Bot")
    } || {
        permited=$(curl -sSL "https://raw.githubusercontent.com/JerrySBG/premium-bot/main/Control/Control-Bot")
    ...
    [[ $(echo $permited | grep "${IP}") = "" ]] || {
        ...
        msg -bar
        [[ -e /usr/bin/downBase ]] || echo 'https://raw.githubusercontent.com/JerrySBG/premium-bot/main/Otros/lista' >/usr/bin/downBase && chmod 777 /usr/bin/downBase
        ...
        [[ -e /usr/bin/downBase ]] || echo 'https://raw.githubusercontent.com/JerrySBG/premium-bot/main/Otros/lista' >/usr/bin/downBase && chmod 777 /usr/bin/downBase
        [[ -e /bin/ShellBot.sh ]] && wget -O /bin/ShellBot.sh https://raw.githubusercontent.com/JerrySBG/premium-bot/main/Otros/ShellBot.sh >/dev/null && chmod +rwx /bin/ShellBot.sh
...
fun_filez() {
    ...
    wget -O /bin/http-server.sh https://raw.githubusercontent.com/JerrySBG/premium-bot/main/Bot/http-server.py  && chmod +x /bin/http-server.sh
...
DOWS() {
    wget -O /root/lista https://raw.githubusercontent.com/JerrySBG/premium-bot/main/Otros/lista
...
atualiza_fun() {
    ...
    wget -q -O /usr/bin/generar https://raw.githubusercontent.com/JerrySBG/premium-bot/main/Menu-Bash/generador.sh && chmod +rwx /usr/bin/generar
    cd $HOME
    msg -bar
